namespace LibEmiddle.Domain
{
    ...
    public class X3DHSession
    {
        ...
        /// </summary>
        /// <param name="recipientIdentityKey">Needed for authenticating the responder in DH1</param>
        /// <param name="senderIdentityKey">Needed for authenticating the initiator in DH2</param>
        /// <param name="ephemeralKey">Needed for DH3 (the X in X3DH)</param>
        /// <param name="usedOneTimePreKey">You must track which signed pre-key was used for rotation logic</param>
        /// <param name="rootKey">Output of KDF (from DHs); required to initialize Double Ratchet</param>
        /// <param name="chainKey">Initial sending chain key; needed for first message encryption</param>
